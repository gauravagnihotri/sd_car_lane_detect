...
![alt text](./readme_ref/_colored_img.jpeg "White and Yellow Filter")
---
### 2. Applying gray scale filter
...
![alt text](./readme_ref/gray_image.jpeg "Gray Scale")
---
...
![alt text](./readme_ref/blur_gray.jpeg "Gaussian Blur")
---
### 4. Applying Canny Edge Detection
...
![alt text](./readme_ref/edges.jpeg "Canny Edge Detect")
---
### 5. Selecting region of interest and applying masking
...
![alt-text](./readme_ref/region_of_interest_red.jpeg "Marked Region of interest")
![alt-text](./readme_ref/masked_edges.jpeg "Region of Interest Resultant")
---
### 6. Identifying Lines using Hough Transform
...
![alt-text](./readme_ref/lane_sketched.jpeg "Hough Transform in action")
---
### 7. Modifying the Draw Lines Function to implement averaging, interpolating and extrapolating
...
![alt-text](./readme_ref/result.jpeg "Final Result")
...
![alt-text](./readme_ref/all_test_images.png "Input Test Images")
---
### Running the pipeline on all the Images in the directory "test_images"

![alt-text](./readme_ref/all_test_images_proc.png "Processed Test Images")
---
...
---
### Running the pipeline on video files (click on the images to open YouTube Video)
